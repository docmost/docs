...
:::tip
To obtain an enterprise license key, contact [sales@docmost.com](mailto:sales@docmost.com).
:::

## Managing Your License

After activating a license, the License & Edition page shows:
...
- **Status** — The current license status (e.g., Valid).

You can **Update license** to replace the current key with a new one, or **Remove license** to revert to the open source edition.

## License Keys and Renewal

License keys are validated offline and do not require an internet connection. When your license is up for renewal, you will receive a new license key. To apply it:
...
The new key replaces the previous one and the updated license details are displayed immediately.

## License Expiry

When an enterprise license expires:

- Enterprise-only features become unavailable.
- All user accounts and content remain intact.
